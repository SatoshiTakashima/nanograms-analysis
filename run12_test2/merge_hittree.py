...
if __name__ == "__main__":
    run10_dir     = Path(__file__).resolve().parent
    products_root = run10_dir / "products"

    for data_type in ["z0cm", "z4cm", "zm4cm"]:
        csv_path      = run10_dir / f"metadata/data_group/data_group_{data_type}.csv"
        output_path   = run10_dir / f"products/hittree_merge_{data_type}.root"
