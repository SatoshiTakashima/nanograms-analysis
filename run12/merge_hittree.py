...
if __name__ == "__main__":
    ...
    products_root = run_dir / "products"

    for data_type in ["test"]:
        csv_path      = run_dir / f"metadata/data_group/data_group_{data_type}.csv"
        output_path   = run_dir / f"products/hittree_merge_{data_type}.root"

        time_ids = read_time_ids(csv_path, "time")
        entries, events = merge_hittrees(
            time_ids=time_ids,
            products_root=products_root / "eventfile",
